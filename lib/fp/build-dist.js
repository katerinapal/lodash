 ...
 */
function build() {
  _async2.default.series([_lodash2.default.partial(_webpack2.default, mappingConfig), _lodash2.default.partial(_webpack2.default, fpConfig), (0, _file.filejs_min)(_path2.default.join(distPath, filename))], _util.utiljs_pitch);
}
