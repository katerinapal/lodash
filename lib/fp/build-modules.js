...
var template = (0, _file.file_globTemplate)(_path2.default.join(templatePath, '*.jst'));
...
function build(target) {
  ...
  var actions = modulePaths.map(function (modulePath) {
    ...
    return (0, _file.file_write)(_path2.default.join(fpPath, moduleName + '.js'), getTemplate(moduleName));
  });

  actions.unshift((0, _file.file_copy)(_path2.default.join(__dirname, '../../fp'), fpPath));
  actions.push((0, _file.file_write)(_path2.default.join(fpPath, '_falseOptions.js'), template._falseOptions()));
  actions.push((0, _file.file_write)(_path2.default.join(fpPath, '_util.js'), template._util()));
  actions.push((0, _file.file_write)(_path2.default.join(target, 'fp.js'), template.fp()));
  actions.push((0, _file.file_write)(_path2.default.join(fpPath, 'convert.js'), template.convert()));

  _async2.default.series(actions, _util.util_pitch);
}
